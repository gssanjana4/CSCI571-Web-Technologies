...
export class FavoritesCard extends Component {
    ...
    render() {
        ...
        const isnytimes = this.props.record.switch===true?'GUARDIAN':'NYTIMES'
        return (
            ...
            pathname:l,
              ...
              state:{
                ...
                <MdDelete style={{cursor: 'pointer',zIndex:'1',position:'relative'}} size={22} onClick={() => {this.props.removeFav(this.props.record.id,this.props.record.title)}}/>
                <Modal
          ...
          >
            <EmailIcon size={52} round />
                   ...
                   <i> {this.props.record.date}</i>
                    ...
                    {' '}
                    <Badge className={"badgeisnytimes "+ isnytimes} variant="info">{isnytimes}</Badge>
                    </div>
                    </Card.Body>
                </Card>
